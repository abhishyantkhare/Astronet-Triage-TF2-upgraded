...
from astronet.tf_slim import evaluation
from astronet.tf_slim.ops import variables as variables_lib
from astronet.tf_slim.training import evaluation as evaluation_lib
...
class EvaluationTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self._expected_accuracy = GroundTruthAccuracy(
    ...
    def _create_names_to_metrics(self, predictions, labels):
        ...
        names_to_values = {'Accuracy': accuracy0,
                           'Another_accuracy': accuracy1}
        names_to_updates = {'Accuracy': update_op0,
    ...
    def testTimeoutFnOnEvaluationLoop(self):
        ...
        evaluation.evaluation_loop(
            '', '', '', timeout=0, timeout_fn=_TimeoutFn)
    ...
    def testWithEpochLimit(self):
        predictions_limited = input.limit_epochs(
            self._predictions, num_epochs=1)
