...
from astronet.tf_slim.tf_slim import summaries
...
class SummariesTest(test.TestCase):
    ...
    def testScalarSummaryIsPartOfCollectionWithNoPrint(self):
        ...
        name = 'my_score'
        prefix = 'eval'
        op = summaries.add_scalar_summary(
            tensor, name, prefix, print_summary=False)
    ...
    def testScalarSummaryIsPartOfCollectionWithPrint(self):
        ...
        prefix = 'eval'
        op = summaries.add_scalar_summary(
            tensor, name, prefix, print_summary=True)
        self.assertIn(op, ops.get_collection(ops.GraphKeys.SUMMARIES))
