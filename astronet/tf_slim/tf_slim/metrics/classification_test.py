...
from astronet.tf_slim.tf_slim.metrics import classification
...
class F1ScoreTest(test.TestCase):
    ...
    def testValueTensorIsIdempotent(self):
        ...
        f1, f1_op = classification.f1_score(
            predictions, labels, num_thresholds=3)
    ...
    def testSomeCorrect(self):
        ...
        f1, f1_op = classification.f1_score(
            predictions, labels, num_thresholds=1)
        with self.cached_session() as sess:
            sess.run(variables.local_variables_initializer())
            sess.run([f1_op])
    ...
    def testAllIncorrect(self):
        ...
        with self.cached_session() as sess:
            ...
            self.assertAlmostEqual(
                2 * 0.5 * 1 / (1 + 0.5), f1.eval(), places=2)
