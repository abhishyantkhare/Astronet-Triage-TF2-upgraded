...
def trunc_normal(
    stddev): return init_ops.truncated_normal_initializer(0.0, stddev)
...
def inception_v3_base(inputs,
    ...
    with variable_scope.variable_scope(scope, 'InceptionV3', [inputs]):
        with arg_scope(
            ...
            net = layers.conv2d(inputs, depth(
                32), [3, 3], stride=2, scope=end_point)
            ...
            if create_aux_logits and num_classes:
                with arg_scope(
                    ...
                    with variable_scope.variable_scope('AuxLogits'):
                        ...
                        kernel_size = _reduced_kernel_size_for_small_input(aux_logits,
                                                                           [5, 5])
                        aux_logits = layers.conv2d(
                            aux_logits,
                            depth(768),
