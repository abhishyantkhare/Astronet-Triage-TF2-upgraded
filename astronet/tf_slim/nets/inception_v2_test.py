...
from astronet.tf_slim import model_analyzer
from astronet.tf_slim.nets import inception_v2
...
class InceptionV2Test(test.TestCase):
    ...
    def testUnknownBatchSize(self):
        ...
        inputs = array_ops.placeholder(
            dtypes.float32, (None, height, width, 3))
