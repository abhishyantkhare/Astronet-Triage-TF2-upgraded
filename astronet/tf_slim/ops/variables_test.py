...
from astronet.tf_slim.ops import variables as variables_lib2
from astronet.tf_slim.ops.arg_scope import arg_scope
...
class LocalVariableTest(test.TestCase):
    ...
    def testGetVariablesDontReturnsTransients(self):
        with self.cached_session():
            ...
            with variable_scope.variable_scope('B'):
                variables_lib2.local_variable(0)
            self.assertEqual([], variables_lib2.get_variables('A'))
            self.assertEqual([], variables_lib2.get_variables('B'))
    ...
    def testGetLocalVariablesReturnsTransients(self):
        with self.cached_session():
            ...
            self.assertEqual([a], variables_lib2.get_local_variables('A'))
            self.assertEqual([b], variables_lib2.get_local_variables('B'))
...
class GlobalVariableTest(test.TestCase):
    ...
    def testGetVariablesReturnsThem(self):
        with self.cached_session():
            ...
            self.assertEqual([a], variables_lib2.get_variables('A'))
            self.assertEqual([b], variables_lib2.get_variables('B'))
    ...
    def testGetLocalVariablesDontReturnsThem(self):
        with self.cached_session():
            ...
            with variable_scope.variable_scope('B'):
                variables_lib2.global_variable(0)
            self.assertEqual([], variables_lib2.get_local_variables('A'))
            self.assertEqual([], variables_lib2.get_local_variables('B'))
...
class GlobalStepTest(test.TestCase):
    ...
    def test_create_global_step(self):
        ...
        with ops.Graph().as_default() as g:
            ...
            self._assert_global_step(
                variables_lib2.create_global_step(ops.Graph()))
    ...
    def test_get_or_create_global_step(self):
        with ops.Graph().as_default() as g:
            self.assertEqual(None, variables_lib2.get_global_step())
            self._assert_global_step(
                variables_lib2.get_or_create_global_step())
            self._assert_global_step(
                variables_lib2.get_or_create_global_step(g))
...
class VariablesTest(test.TestCase):
    ...
    def testCreateVariable(self):
        with self.cached_session():
            with variable_scope.variable_scope('A'):
                ...
                self.assertEqual(a.op.name, 'A/a')
                self.assertListEqual(a.get_shape().as_list(), [5])
                self.assertIn(a, ops.get_collection(
                    ops.GraphKeys.GLOBAL_VARIABLES))
                self.assertNotIn(a, ops.get_collection(
    ...
    def testGetVariables(self):
        with self.cached_session():
            ...
            self.assertEqual([a, b], variables_lib2.get_variables())
            self.assertEqual([a], variables_lib2.get_variables('A'))
            self.assertEqual([b], variables_lib2.get_variables('B'))
    ...
    def testGetVariablesSuffix(self):
        with self.cached_session():
            ...
            with variable_scope.variable_scope('A'):
                b = variables_lib2.variable('b', [5])
            self.assertEqual([a], variables_lib2.get_variables(suffix='a'))
            self.assertEqual([b], variables_lib2.get_variables(suffix='b'))
    ...
    def testGetVariableWithSingleVar(self):
        with self.cached_session():
            ...
            self.assertEqual(
                a, variables_lib2.get_unique_variable('parent/child'))
    ...
    def testGetVariablesToRestore(self):
        with self.cached_session():
            ...
            with variable_scope.variable_scope('B'):
                b = variables_lib2.variable('a', [5])
            self.assertEqual([a, b], variables_lib2.get_variables_to_restore())
    ...
    def testIncludeGetVariablesToRestore(self):
        with self.cached_session():
            ...
            self.assertEqual([a, b], variables_lib2.get_variables())
            self.assertEqual(
                [a], variables_lib2.get_variables_to_restore(['A']))
    ...
    def testWrongIncludeGetVariablesToRestore(self):
        with self.cached_session():
            ...
            self.assertEqual([a, b], variables_lib2.get_variables())
            self.assertEqual(
                [], variables_lib2.get_variables_to_restore(['a']))
    ...
    def testGetMixedVariablesToRestore(self):
        with self.cached_session():
            ...
            self.assertEqual([a, b, c, d], variables_lib2.get_variables())
            self.assertEqual(
                [a, c],
...
class ModelVariablesTest(test.TestCase):
        ...
        with self.cached_session():
            with variable_scope.variable_scope('A'):
                ...
                self.assertListEqual(
                    [a], variables_lib2.get_model_variables('A'))
    ...
    def testGetModelVariables(self):
        with self.cached_session():
            ...
            with variable_scope.variable_scope('B'):
                b = variables_lib2.model_variable('a', [5])
            self.assertEqual([a], variables_lib2.get_model_variables('A'))
            self.assertEqual([b], variables_lib2.get_model_variables('B'))
...
class GetVariablesCollections(test.TestCase):
    ...
    def testVariableCollection(self):
        with self.cached_session():
            ...
            self.assertEqual(a, ops.get_collection('A')[0])
            self.assertEqual(b, ops.get_collection('B')[0])
...
class GetVariablesBySuffixTest(test.TestCase):
    ...
    def testGetVariableGivenNameScoped(self):
        with self.cached_session():
            with variable_scope.variable_scope('A'):
                ...
                b = variables_lib2.variable('b', [5])
                self.assertEqual(
                    [a], variables_lib2.get_variables_by_suffix('a'))
                self.assertEqual(
                    [b], variables_lib2.get_variables_by_suffix('b'))
    ...
    def testGetVariableWithScope(self):
        with self.cached_session():
            ...
            self.assertEqual([a, fooa, a2], matched_variables)
            matched_variables = variables_lib2.get_variables_by_suffix('/a')
            self.assertEqual([a, a2], matched_variables)
            matched_variables = variables_lib2.get_variables_by_suffix(
                'a', scope='A')
            self.assertEqual([a, fooa], matched_variables)
    ...
    def testGetVariableWithoutScope(self):
        with self.cached_session():
            ...
            matched_variables = variables_lib2.get_variables_by_suffix('a')
            self.assertEqual([a, fooa, b_a], matched_variables)
            matched_variables = variables_lib2.get_variables_by_suffix('fooa')
            self.assertEqual([fooa], matched_variables)
...
class GetVariablesByNameTest(test.TestCase):
    ...
    def testGetVariableGivenNameScoped(self):
        with self.cached_session():
            with variable_scope.variable_scope('A'):
                ...
                b = variables_lib2.variable('b', [5])
                self.assertEqual(
                    [a], variables_lib2.get_variables_by_name('a'))
                self.assertEqual(
                    [b], variables_lib2.get_variables_by_name('b'))
    ...
    def testGetVariableWithScope(self):
        with self.cached_session():
            ...
            self.assertEqual([fooa], matched_variables)
            matched_variables = variables_lib2.get_variables_by_name('/a')
            self.assertEqual([], matched_variables)
            matched_variables = variables_lib2.get_variables_by_name(
                'a', scope='A')
    ...
    def testGetVariableWithoutScope(self):
        with self.cached_session():
            ...
            b_a = variables_lib2.variable('B/a', [5])
            matched_variables = variables_lib2.get_variables_by_name('a')
            self.assertEqual([a, b_a], matched_variables)
            matched_variables = variables_lib2.get_variables_by_name('fooa')
            self.assertEqual([fooa], matched_variables)
...
class GetVariableFullNameTest(test.TestCase):
    ...
    def testVariable(self):
        ...
        self.assertEqual(full_name, my_var0.op.name)
    ...
    def testPartitionedVariable(self):
        ...
        for part_var in list(my_var0):
            computed_full_name = variables_lib2.get_variable_full_name(
                part_var)
            self.assertEqual(input_full_name, computed_full_name)
...
class AssignFromValuesTest(test.TestCase):
    ...
    def testNoScopes(self):
        ...
        with self.cached_session() as sess:
            ...
            var_names_to_values = {
                'my_var0': init_value0, 'my_var1': init_value1}
...
class AssignFromCheckpointTest(test.TestCase):
    ...
    def create_checkpoint_from_values(self,
        ...
        with session.Session('', graph=ops.Graph()) as sess:
            ...
            for var_name in var_names_to_values:
                ...
                var_list.append(variables_lib.VariableV1(
    ...
    def testLoadPartitionedVariables(self):
        ...
        with self.cached_session() as sess:
            ...
            vars_to_restore = {'var0': list(
                var0) + [var0full], 'var1': list(var1)}
            op, feed_dict = variables_lib2.assign_from_checkpoint(
                model_path, vars_to_restore)
    ...
    def testRaisesValueErrorIfAVariableIsntFound(self):
        ...
        with self.cached_session():
            ...
            with self.assertRaises(ValueError):
                variables_lib2.assign_from_checkpoint(
                    model_path, vars_to_restore)
    ...
    def testInitFromCheckpointWithScopes(self):
        ...
        var_names_to_values = {
            'layer0/v0': init_value0, 'layer1/v1': init_value1}
        ...
        with self.cached_session() as sess:
            ...
            with variable_scope.variable_scope('my_model/my_layer0'):
                var0 = variables_lib2.variable(
                    'my_var0', shape=init_value0.shape)
            with variable_scope.variable_scope('my_model/my_layer1'):
                var1 = variables_lib2.variable(
                    'my_var1', shape=init_value1.shape)
...
class AssignFromCheckpointFnTest(test.TestCase):
    ...
    def testLoadExistingVariablesDifferentShapeAllowReshape(self):
        ...
        with self.cached_session() as sess:
            ...
            # Request and test the variable values:
            self.assertAllEqual(np.transpose(
                np.array(init_value0)), var0.eval())
            self.assertEqual(init_value1, var1.eval())
