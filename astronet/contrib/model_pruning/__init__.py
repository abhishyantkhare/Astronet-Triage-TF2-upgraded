...
from astronet.contrib.model_pruning.python.strip_pruning_vars_lib import graph_def_from_checkpoint
from astronet.contrib.model_pruning.python.strip_pruning_vars_lib import strip_pruning_vars_fn
