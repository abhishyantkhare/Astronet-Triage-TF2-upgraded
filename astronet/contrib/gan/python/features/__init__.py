...
from astronet.contrib.gan.python.features.python import spectral_normalization
...
from astronet.contrib.gan.python.features.python.spectral_normalization import *
